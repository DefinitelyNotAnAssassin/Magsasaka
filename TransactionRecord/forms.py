...
class TransactionRecordForm(ModelForm): 
    ...
    class Meta: 
        ...
        widgets = {
                ...
                'date': forms.DateInput(attrs={'class': 'shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline', 'placeholder' : 'MM/DD/YY'}),
